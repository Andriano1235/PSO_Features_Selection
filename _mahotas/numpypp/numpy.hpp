...
#define DECLARE_DTYPE_CODE(type, constant)                         \
  template <>                                                      \
  inline npy_intp dtype_code<type>() { return constant; }          \
                                                                   \
  template <>                                                      \
  inline npy_intp dtype_code<const type>() { return constant; }    \
                                                                   \
  template <>                                                      \
  inline npy_intp dtype_code<volatile type>() { return constant; } \
                                                                   \
  template <>                                                      \
  inline npy_intp dtype_code<volatile const type>() { return constant; }
